...
/datum/lighting_corner/Destroy(var/force)
	...
	stack_trace("Ok, Look, /tg/, I need you to find whatever fucker decided to call qdel on a fucking lighting corner, then tell him very nicely and politely that he is 100% smerg and needs his head checked. Thanks. Send them my regards by the way.")
